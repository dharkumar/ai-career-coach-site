...
const CARD_MAP: Record<string, React.FC<any>> = {
    ...
    'glassmorphicoptions': GlassmorphicOptions,
    ...
    'cardstacktemplate': CardStackTemplate,
    'cardstackjobpreviewsheet': CardStackJobPreviewSheet,
    'jobsearchsheet': JobSearchSheet,
    'jobdetailsheet': JobDetailSheet,
    'eligibilitysheet': EligibilitySheet,
    'closegapsheet': CloseGapSheet,
    'jobapplicationssheet': JobApplicationsSheet,
    'pastapplicationssheet': PastApplicationsSheet,
    'profilesheet': ProfileSheet,
    'skillcoveragesheet': SkillCoverageSheet,
    'marketrelevancesheet': MarketRelevanceSheet,
    'careergrowthsheet': CareerGrowthSheet,
    'skillsdetail': SkillsDetail,
    'marketrelevancedetail': MarketRelevanceDetail,
    'careergrowthdetail': CareerGrowthDetail,
    'mylearningtemplate': MyLearningTemplate,
